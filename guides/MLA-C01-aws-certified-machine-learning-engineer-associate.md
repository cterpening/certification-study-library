...
**Replacement:** [MLA-C02 official exam guide](https://docs.aws.amazon.com/aws-certification/latest/machine-learning-engineer-associate-02/machine-learning-engineer-associate-02.html). New learners should normally prepare for MLA-C02. This page exists for candidates already scheduled for C01 and for historical/reference use; passing C01 earns the certification, not an automatic exam-version conversion.<br>
