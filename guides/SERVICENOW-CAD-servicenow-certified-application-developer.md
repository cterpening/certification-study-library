...
| [Plan before you build](https://www.servicenow.com/docs/r/application-development/plan-before-you-build.html) | Public | 30–60 min plus lab | Current Australia-release guidance for scope, instance and naming decisions; product practice, not exam-scope evidence |
| [Custom scoped-app ACL security](https://www.servicenow.com/community/developer-articles/servicenow-custom-scoped-app-security-a-developer-s-guide-to/ta-p/3484927) | Public/community | 60–90 min plus lab | 2026 ServiceNow employee-authored security matrix and negative-test practice; community guidance, so reconcile API details with product docs |
| [Community CAD preparation discussion](https://www.servicenow.com/community/training-and-certifications/cad-exam-prep/td-p/3538814) | Public/community | 15–30 min | May 2026 PDI/lab emphasis and useful out-of-scope warning; not blueprint authority, and do not adopt its rough percentages or third-party mock-test suggestions |
