...
| [Pluralsight — AB-900 path](https://www.pluralsight.com/paths/microsoft-365-copilot-and-agent-administration-fundamentals-ab-900) | Subscription | 9 hours | Three-course path published June–July 2026 by Vlad Catrinescu |
...
No current instruction-first Whizlabs AB-900 course was verified on August 31, 2026. The MeasureUp product above is a gap-detection supplement, not explanatory learning. See the broader [Places to learn catalog](../docs/LEARNING-RESOURCES.md).
