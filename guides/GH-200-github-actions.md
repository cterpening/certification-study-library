...
| [John Savill — DevOps Master Class](https://www.youtube.com/playlist?list=PLlVtbbG169nFr8RzQ4GIxUEznpNR53ERq) | Free | About 2 hours for CI/CD part | Strong supporting explanations; [Part 4: CI/CD](https://www.youtube.com/watch?v=nLRHV2sRTe8) demonstrates workflows, triggers, runners, actions, environments, approvals, and matrices; not an end-to-end GH-200 course |

No Whizlabs or Udemy course is listed yet because the GH-200 offerings reviewed were primarily practice-question products rather than explanatory instruction. See the broader [Places to learn catalog](../docs/LEARNING-RESOURCES.md).
