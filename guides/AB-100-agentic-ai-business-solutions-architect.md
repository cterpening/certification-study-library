...
| [O'Reilly — Building Enterprise AI Agents](https://www.oreilly.com/videos/building-enterprise-ai/9781808080630/) | Subscription | Use provider runtime; add lab time | Supporting enterprise agent patterns; not an AB-100 objective checklist |
...
| [Udemy — AB-100 preparation by Kuljot Singh Bakshi](https://www.udemy.com/course/ab-100-agentic-ai-business-solutions-architect-exam-prep/) | Purchase or subscription | Use current provider runtime | Alternative course shown as updated June 2026; inspect previews and objective coverage before choosing |
...
No exact Pluralsight or instruction-first Whizlabs AB-100 course was verified during the August 30, 2026 review. Practice-question-only products are intentionally not used as the explanatory learning recommendation. See the broader [Places to learn catalog](../docs/LEARNING-RESOURCES.md).
