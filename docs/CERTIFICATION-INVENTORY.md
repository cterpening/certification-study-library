...
incremental; Data Analyst Associate, both Data Engineer levels and Machine
Learning Associate are registered.
...
so far. Repeat that live-page-plus-linked-PDF rule for the remaining three
credentials.
