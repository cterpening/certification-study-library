...
incremental; both associate guides and Data Engineer Professional are registered.
...
so far. Repeat that live-page-plus-linked-PDF rule for the remaining four
credentials.
