...
The internal `source-validated` state powers the repository workflow. On the public site it is deliberately displayed as **Sources + objectives checked — human review pending**. The guide was checked against the current official objective snapshot, its material explanations have supporting public sources, volatile details are marked **VERIFY CURRENT**, repository and external links validate, and the content passes the project's exam-integrity policy. Supporting technical sources may include evaluated non-vendor material; that material must be cited and visibly labeled when first-party confirmation is incomplete, and it never defines the exam contract.
...
| AB-900 | September 5, 2026 | July 22, 2026 objectives; unchanged during repair revalidation | 37 registered links: 34 reachable, 3 access-blocked, 0 missing/error | Passed |
| AB-650 | September 5, 2026 | July 27, 2026 beta objectives; unchanged during repair revalidation | 26 registered links: 26 reachable, 0 access-blocked, 0 missing/error | Passed |
...
The guide maps every July 27, 2026 objective bullet to a bidirectional packet-walk method, service and control comparisons, failure modes, two cross-domain scenarios, eight independent labs, and 24 original knowledge checks. The September 5 repair adds substantive requirements, configuration, validation, and troubleshooting coverage for Azure Network Adapter and Azure Extended Network in Section 3 and Lab 4. The September 7 living-guide pass adds the direct virtual network flow-log source, the NSG flow-log creation/retirement boundary, and the agentless Connection troubleshoot preview boundary. It cites 31 exact registered sources: 28 were reachable, while two O'Reilly pages and one Udemy page remain access-blocked. The official objective snapshot SHA-256 is `949dcb2d1b4bbde19b6f41b69fdf59cf33b52391d4b8010e2a46d6a0c94a98dd`.
...
| Apply modern development practices | Parts 9–11, including the individual/Business/Enterprise comparison in Part 11 §11.2 |
...
The review removed a duplicated GH-300-specific chapter from the GH-900 guide, retained a concise related-guide handoff, and added primary-reference blocks near each substantive part. The September 5 repair maps the blueprint's legacy Individuals label to current individual offerings and distinguishes individual ownership from Business seat/policy management and Enterprise eligibility/capabilities. The official blueprint snapshot SHA-256 is `bd1c323a21723f8479a7b79ec41a576044ebe6afbc5bf57715acf431fe90828b`.
...
The review added direct primary sourcing beside all three security suites and an explicit model separating repository visibility, entitlement, deployment, policy, configuration, and operational health. The September 5 repair restricts product campaigns to code- and secret-scanning alerts, labels secret campaigns public preview, and separates dependency remediation initiatives. The official blueprint snapshot SHA-256 is `a935dc15cfa929c01d402424f0edc39bb018b4c600ce734bd7cf10e1446ae102`.
...
| Implement computer vision solutions | Part 6, multimodal implementation in Part 9, and Labs 5 and 7 |
| Implement text analysis solutions | Part 7 and speech/translation operations in Part 9 |
| Implement information extraction solutions | Part 8, retrieval/Content Understanding implementation in Part 9, and Labs 6–7 |

The review retained the guide's architecture and production-operations depth while adding primary Microsoft citations at the decisions they support. The September 5 repair adds a seventh lab and a version-bounded Sora 2 remix workflow, then maps the blueprint's historical single-task/pro-mode terms to the retired Standard/Pro API, current GA analyzers, and preview agentic mode without recommending a retired endpoint. All 44 cited URLs are cataloged: 43 reachable and one access-blocked. The official blueprint snapshot SHA-256 is `3fbf0ebd6b3d5e591d7354de47f8d87baaea121330a209e9104045447ac70f63`.
...
| Understand data protection and governance tasks for Microsoft 365 and Copilot | Parts 4–5, Data Explorer in Part 4, objective-to-scenario drill, and Lab 4/check 7 |
| Perform basic administrative tasks for Copilot and agents | Agent lifecycle in Part 6, objective-to-scenario drill, and Labs 5–6/check 8 |

The review corrected the objective labels to the published wording and expanded the guide into a repeatable object, entitlement, identity, authorization, protection, admin-surface, and evidence method. The September 5 repair adds Purview Data Explorer investigation and an Agent Builder create/test/private-by-default/approval/distribution workflow, bringing the guide to six labs and eight checks. All 37 cited URLs are cataloged: 34 reachable and three access-blocked. Fast-changing Copilot, Purview, agent, license, and admin-surface details remain explicitly volatile. The official blueprint snapshot SHA-256 is `8e38035a94d260856ff5c08899492597046213510e057128edd89d775d363b90`.
...
| Manage virtual machines and containers | Section 4, Azure application scenario, and Labs 5–6 and 9; SSH Direct is covered provisionally with an explicit evidence gap |
| Implement and manage an on-premises and hybrid networking infrastructure | Section 5, branch and Azure application scenarios, and Labs 7 and 9 |
| Manage storage and file services | Section 6, file-server migration scenario, and Lab 8 |

The September 5 repair corrects Azure Extended Network's on-premises-subnet-to-Azure-VNet boundary and adds prerequisites, configuration, validation, troubleshooting, cleanup, and Lab 9 coverage for Azure Network Adapter and Extended Network. The September 7 best-effort pass documents SSH Direct instead of omitting it: Microsoft confirms the Hyper-V/VSOCK substrate, Microsoft-owned lab code provides an older Debian composition, and qualified Ubuntu, Red Hat-family, SUSE/openSUSE, Oracle Linux, systemd, libvirt, Microsoft Press, and expert sources support pieces of the provisional model. Source validation remains blocked because Microsoft still publishes no current end-to-end implementation contract or compatibility matrix establishing supported host/guest combinations, authentication, configuration, validation, and troubleshooting. The record therefore remains `review-required`, not a passed source validation. The guide has three scenarios, nine labs, and 24 checks. All 77 cited URLs are cataloged: 73 reachable, four access-blocked, and none missing. The official blueprint snapshot SHA-256 is `03c6f4e0c73f383ada8c4ddf43a91fa28ec513a732b40abae0a38b1b6ac4f7bc`.
...
The review maps every October 6, 2025 subobjective to requirement, dependency, control, evidence, failure action, and recovery proof. Three integrated scenarios, eight labs, and 24 original knowledge checks cover security, clustering/S2D, backup/replication, server/workload/forest migration, monitoring, and layered troubleshooting. All 87 cited URLs are cataloged: 84 were reachable, while two O'Reilly books and one Udemy page were access-blocked; none was missing or broken. The September 7 pass adds Windows Server release/feature feeds, the Azure Monitor change feed, and the June 30, 2028 VM Insights Map and Dependency Agent retirement boundary while explicitly preserving unaffected AMA-based performance monitoring. The guide distinguishes current AMA/DCR from retired MMA/OMS, records ADMT's deprecated support state, and marks Azure Disk Encryption's September 15, 2028 retirement and encryption-at-host direction. It prominently records AZ-801 retirement on September 30, 2026 at 5:00 PM Central Standard Time, links AZ-802, and discloses the canonical-study-guide versus exam-page weight discrepancy. The official blueprint snapshot SHA-256 is `c279fe648d4e3a6c67df9e119c95335e042937b93b83ffbf6a07d7f0ce51a76f`.
...
| Manage virtual machines | Section 4, consolidated operating scenario, and Labs 4–5; SSH Direct is covered provisionally with an explicit evidence gap |
...
Six objective groups and the documented portions of the virtual-machine group map to operating dependencies, decisions, failure signals, and recovery proof. SSH Direct remains an explicit evidence exception. The September 7 best-effort pass restores a bounded, cited technical model from Microsoft Hyper-V/VSOCK documentation, Microsoft-owned Debian lab code, and qualified Ubuntu, Red Hat-family, SUSE/openSUSE, Oracle Linux, systemd, libvirt, Microsoft Press, and expert evidence. It also provides a read-only preflight, confidence matrix, negative tests, and rollback. The source-validation record remains blocked and the guide stays `review-required` because Microsoft has not published a current end-to-end support contract, universal distribution procedure, authentication boundary, or compatibility matrix. The guide has three scenarios, eight labs, and 28 checks. All 79 cited URLs are cataloged: 74 reachable, five access-blocked, and none missing. The official blueprint snapshot SHA-256 is `ec584efe0ea08ae5ad6bbcef992c1b4a4e6b18826193ece06a76114757c8f65d`.
...
| Manage and secure AI services in Microsoft 365 | Section 3 agent identity/settings/templates/Purview coverage, all scenarios, Labs 2 and 6–9, and checks 37–40 |

The September 5 repair adds distinct Entra Agent ID lifecycle and blueprint handling, tenant agent settings and allowed types, Agent 365 policy templates, Purview default onboarding versus explicitly scoped controls, and compliance-gap remediation. Three scenarios, nine labs, and 40 checks exercise the current coverage. All 26 cited URLs were reachable. Fast-moving AI, Agent 365, Copilot, and portal behavior remains marked **VERIFY CURRENT**. Blueprint SHA-256: `e70d10682f078cb6887f7dde679f56661e63dfeabb221779f6b0ff4ab08bdf1a`.
...
| Optimize endpoint operations by using automation, monitoring, and reporting | Section 5 alert-rule workflow, all scenarios, Lab 8, and checks 37–39 |

The September 5 repair adds source-aware alert paths for compliance drift, enrollment failure, and configuration conflicts, including source latency, query/threshold/scope decisions, action groups, validation, tuning, cleanup, and safe Lab 8 practice. Three scenarios, eight labs, and 39 checks cover the full objective map. All 40 cited URLs are cataloged: 37 reachable, three access-blocked, and none missing. Fast-moving Intune and alert surfaces remain marked **VERIFY CURRENT**. Blueprint SHA-256: `ba90e464c3a81deac207962ffe32e88c3ac6b0d966c33ba77572bb3d83910009`.
...
- Coverage evidence: guide sections 1–5, three integrated administration scenarios, eight safe performance labs, 42 original checks, and explicit release-watch/controller-lifecycle/course-gap boundaries
...
The review maps every v1.35 domain to a confirm context/namespace/owner → inspect desired and observed state → change the correct controlling resource → verify readiness, traffic, persistence, security and recovery workflow. Three scenarios, eight labs and 42 original checks cover RBAC, kubeadm/HA/lifecycle/etcd, Helm/Kustomize/interfaces/CRDs/operators, controllers/configuration/probes/scaling/admission/scheduling, Pod/Service/EndpointSlice/DNS/NetworkPolicy/Ingress/Gateway paths, StorageClass/PV/PVC/CSI behavior, and node/control-plane/workload/network/storage troubleshooting. All ten URLs are cataloged: eight reachable and O'Reilly plus Udemy automation-blocked; none missing or broken. The official page's v1.35 baseline is preserved after the August 26 v1.37 release; the 4–8-week policy creates a September 23–October 21 recheck window, not a promised switch date. The retired ingress-nginx community controller is separated from the stable Ingress API and current objective. No proprietary simulator tasks, course labs or recalled exam tasks are used. Blueprint SHA-256: `e4b196b215d9a8a74203f309fa7b755633fe99955e638e541b3a6eac147d2857`.
...
- Coverage evidence: guide sections 1–5, three integrated application scenarios, eight safe performance labs, 42 original checks, and explicit release-watch/controller-lifecycle/course-gap boundaries
- Link evidence: ten unique external guide URLs; eight reachable, two automation-blocked, zero missing/broken in the dated source-health evidence
...
The review maps every v1.35 domain to one source/image → workload/volume → rendered release → observable runtime → least-privilege identity/configuration → Service/policy/Ingress lifecycle. Three scenarios, eight labs and 42 original checks cover image contracts, controllers, multi-container patterns and volumes; rolling/blue-green/canary delivery plus Helm/Kustomize; probes, CLI metrics, streams/debugging and API deprecations; CRDs/operators, authentication/authorization/admission, requests/limits/quotas, ConfigMaps/Secrets/ServiceAccounts and security contexts/capabilities; and Service/EndpointSlice/NetworkPolicy/Ingress paths. All ten URLs are cataloged: eight reachable and O'Reilly plus Udemy automation-blocked; none missing or broken. The official page's v1.35 baseline is preserved after the August 26 v1.37 release; the 4–8-week policy creates a September 23–October 21 recheck window, not a promised switch date. The retired ingress-nginx community controller is separated from the stable Ingress API and current objective. No proprietary simulator tasks, course labs or recalled exam tasks are used. Blueprint SHA-256: `58b0290b61ba14ad68c02e06bcd2fbec14d23c4e555e69eb67a5615047e02ca1`.
...
- Coverage evidence: guide sections 1–6, three integrated defensive scenarios, eight authorized performance labs, 42 original checks, and explicit live-page/CNCF-page/PDF, CKA-prerequisite, release-watch, and controller-lifecycle boundaries
- Link evidence: 11 unique external guide URLs; nine reachable, two automation-blocked, zero missing/broken in the dated source-health evidence
...
The review maps every live v1.35 domain to an asset/trust-boundary/threat → narrow preventive control → positive and negative validation → telemetry/detection → authorized containment/recovery lifecycle. Three scenarios, eight labs and 42 original checks cover network/CIS/TLS/metadata/binary setup; RBAC/ServiceAccounts/API access/upgrades; minimal hosts/IAM/network/seccomp/AppArmor; current Pod Security, Secrets, tenancy/sandboxing and Pod-to-Pod encryption; minimal images, SBOM/provenance, CI/artifact repositories, signatures/admission and static/image analysis; plus behavioral detection, cross-layer investigation, runtime immutability and Kubernetes audit. All 11 URLs are cataloged: nine reachable and O'Reilly plus Udemy automation-blocked; none missing or broken. The guide follows the live Linux Foundation 15/15/10 first-three weights while clearly flagging CNCF's lingering 10/15/15 overview and v1.34 PDF, and corrects the prerequisite to previously passed CKA with no active-status requirement. The official August 26 v1.37 release creates a September 23–October 21 recheck window without changing the live v1.35 baseline; the retired community ingress-nginx controller is separated from the stable Ingress API and current objective. No offensive target instructions, proprietary simulator tasks, course labs or recalled exam tasks are used. Blueprint SHA-256: `26ca4b0afc590f0df1dbf0ed60a435ce420efc6ac6d4ae95ec41dac302925c98`.
...
The review maps each public objective through business requirement and data owner → declarative/programmatic boundary → least privilege and data model → formulas, validation, Flow/approval and bounded agent action → persona/form-factor UI → versioned dependency-aware deployment → verification, monitoring and rollback evidence. It covers sharing and analytics, relationship and field consequences, controlled data movement, bulk-safe and observable automation, Lightning/mobile activation, sandboxes/change sets/packages and ALM. Three scenarios, eight labs and 40 checks are included. The prior blocked audit was caused by incorrect Help article `005389157`; canonical `005298964` exposes the complete August 21 scope matching the snapshot. A Salesforce certification-team interview and independent ForceAcademy summary are clearly ranked below the blueprint, and no question-bank content was used. Ten URLs are reachable and one O'Reilly page is automation-blocked; none are broken. Blueprint SHA-256: `5365cb37f260db38aa6b4a306dd826258e3d85f058b8111352e56a065a965f14`.
...
- Link evidence: 12 unique external guide URLs; 11 reachable, one automation-blocked, zero missing/broken in dated source-health evidence
...
The review maps all six weighted domains through role-aware navigation and record context, supported instance change, collaborative lists/forms/tasks/analytics/notifications, governed knowledge/catalog/flow/Virtual Agent paths, controlled schema/import/CMDB/security design, and testable UI policies, Business Rules, scripting and update-set transport. Three scenarios, eight safe labs and 40 checks are included. Complete indexed KB0011554 text now confirms the snapshot, contract and maintenance boundary despite the simple-client loading shell. A user-authored community checklist is labeled as broad practice context only, not scope or exam-contract authority; its comments and arbitrary flashcard/mock links are excluded. Ten URLs are reachable and two are automation-blocked; none are broken. Only ServiceNow's official MeasureUp product is listed for exam-style questions. No recalled/live item, answer dump or copied course content is used. Blueprint SHA-256: `9a7543abda6dcc1af08f0fba350c382652ed41eac6a2de9599f7c80d223b99e9`.
...
- Volatile boundaries: the official MeasureUp 20/20/20/20/10/10 practice-bank distribution versus the KB0011498 15/20/20/20/10/15 evidence baseline; twice-yearly release UI/API/tooling; dynamic course access/duration; PDI availability; Pearson policy/price/language; scoring review; annual delta and CMP

The review maps all six January 2026 evidence-baseline domains through requirement and platform-fit decisions, scoped data/application design, persona-tested client and server behavior, layered access and cross-scope security, idempotent declarative/scripted automation, reconciled CSV/Excel and REST integration, and controlled repository/Git/delegated-development delivery with tests and rollback. Three scenarios, eight safe labs and 40 checks are included. KB0011498 resolves but still exposes only its title to deterministic and indexed extraction, so its weights, tasks and contract remain blocked pending a fully rendered or static official source. Current official planning documentation and a ServiceNow employee-authored ACL article add bounded practice; a May community discussion is explicitly non-authoritative, and its rough percentages and third-party mock suggestions are excluded. The MeasureUp distribution remains a documented discrepancy, not a replacement blueprint. Eleven URLs are reachable and three are automation-blocked; none are broken. Only ServiceNow's official MeasureUp product is listed for exam-style questions. No recalled/live item, answer dump or copied course content is used. Blueprint SHA-256: `d0d60a1f5b77d3baa45857b05b7e01c67ab7f5afdbc53dc0558c660f244b21b0`.
...
- Coverage evidence: guide sections 1–5, an integrated professional Python build, 12 correctly mapped hands-on labs, 23 original readiness checks, and explicit identity/value, built-in-subclass/composition/wrapper, decorator/metaclass, PEP/convention, event-loop/thread, socket/HTTP, transport/application-status, serialization/trust, and path/encoding boundaries
- Link evidence: 11 unique external guide URLs; ten reachable, one automation-blocked, zero missing/broken in dated source-health evidence
...
methods, built-in subclassing, decorators, metaclasses and persistence; PEP 8/257 and documentation;
Tkinter event-driven design; sockets, HTTP, REST, XML and JSON; and database,
file, logging, configuration and environment modules. Twelve labs and 23 original
...
answer dump or copied course content is used. Blueprint SHA-256:
`979e1a08fc3b397566e6549bae8cbfc70238b37d5652f54fadde55f1011c3598`.
...
## PANW-NGFW-ENGINEER coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: PAN-OS Networking Configuration (40%); PAN-OS Device Setting Configuration (40%); Integration and Automation (20%)
...
- Link evidence: 15 unique external guide URLs; 14 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification status, datasheet revision, product behavior and terminology, tenant access, learning availability and exam logistics

The review maps every published domain to applied evidence and keeps related items separate from the objective contract. No recalled/live item, answer dump or copied course content is used. Blueprint SHA-256: `e6d1470d49b1d63602c5021bf347751e6b64443817cdda1e9700bd4a10486806`.


## PANW-SD-WAN-ENGINEER coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Planning and Design (24%); Deployment and Configuration (24%); Operations and Monitoring (18%); Unified SASE (14%); Troubleshooting (20%)
...
- Link evidence: 13 unique external guide URLs; 12 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification status, datasheet revision, product behavior and terminology, tenant access, learning availability and exam logistics
...
## PANW-XSIAM-ENGINEER coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Planning and Installation (22%); Integration and Automation (30%); Content Optimization (24%); Maintenance and Troubleshooting (24%)
- Coverage evidence: guide sections 1–4, integrated scenarios, authorized labs, original readiness checks, and explicit product, architecture, governance and security boundaries
- Link evidence: 17 unique external guide URLs; 16 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification status, datasheet revision, product behavior and terminology, tenant access, learning availability and exam logistics

The review maps every published domain to applied evidence and keeps related items separate from the objective contract. No recalled/live item, answer dump or copied course content is used. Blueprint SHA-256: `01fcfc3a45ecdf45cdd41d9dfa6e33f6d30360991d2be20807fe2d9fcf6130ca`.


## PANW-XSOAR-ENGINEER coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Planning, Installation, and Maintenance (14%); Use Case Planning and Development (22%); Playbook Development (30%); Incident Interactions and Reporting (16%); Threat Intelligence Management (18%)
- Coverage evidence: guide sections 1–5, integrated scenarios, authorized labs, original readiness checks, and explicit product, architecture, governance and security boundaries
- Link evidence: 17 unique external guide URLs; 16 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification status, datasheet revision, product behavior and terminology, tenant access, learning availability and exam logistics

The review maps every published domain to applied evidence and keeps related items separate from the objective contract. No recalled/live item, answer dump or copied course content is used. Blueprint SHA-256: `43a17a64086c63ac3a769b6279b2c31cb3eec4e85f69fe62f8f88dae4a8c504c`.


## PANW-NETWORK-SECURITY-ARCHITECT coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Zero Trust Enterprise (8%); AI Security (11%); Centralized Management and IAM (13%); SSE Private Application Access (11%); Mobile User Security (7%); Modernizing Branches (11%); Data Security (7%); Securing IoT Environments (11%); Public Cloud (11%); Private Cloud (PA-Series, VM-Series, Hypervisors) (10%)
- Coverage evidence: guide sections 1–10, integrated scenarios, authorized labs, original readiness checks, and explicit product, architecture, governance and security boundaries
- Link evidence: 28 unique external guide URLs; 26 reachable, 2 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification status, datasheet revision, product behavior and terminology, tenant access, learning availability and exam logistics
...
## NSE-7-CLOUD-SECURITY coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Security solutions deployment; Automation tools; Cloud infrastructure monitoring; Troubleshooting
...
## NSE-2-CYBERSECURITY coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: What is Next Generation Firewall; How Firewall Policies Work; User Authentication in NGFW; Blocking Malware; Controlling Web Access with Web Filtering; Intrusion Prevention System and Application Control; Connecting Multiple Locations Securely; Secure SD-WAN; SASE
- Coverage evidence: guide sections 1–9, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 8 unique external guide URLs; 7 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules
...
## NSE-5-SASE coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Decentralized SD-WAN (20-30%); Rules and routing (15-25%); SASE deployment (20-30%); Secure internet access and secure SaaS access (15-25%); Analytics (15-25%)
- Coverage evidence: guide sections 1–5, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 10 unique external guide URLs; 10 reachable, 0 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules

The review maps published scope without inventing unpublished weights or hidden objectives. Related items remain separate from the provider contract. Blueprint SHA-256: `0873782a14bab76e6f3da5c9f18af642eaec585670d80bd74e6f66f073764729`.


## NSE-5-CLOUD-SECURITY coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Fortinet NSE 5 - FortiWeb 8.0 Administrator; Fortinet NSE 5 - FortiAppSec Cloud 26 Administrator; Fortinet NSE 5 - FortiADC Administrator
- Coverage evidence: guide sections 1–4, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 12 unique external guide URLs; 12 reachable, 0 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules

The review maps published scope without inventing unpublished weights or hidden objectives. Related items remain separate from the provider contract. Blueprint SHA-256: `6053cab73f8ab3fd9cf74db3daf454ce557a22d880c3ec6451688f9d6e5e3060`.


## NSE-5-SECURITY-OPERATIONS coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Features and concepts; Log Analysis; SOC operation and automation; Reports
- Coverage evidence: guide sections 1–4, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 8 unique external guide URLs; 8 reachable, 0 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules
...
## NSE-6-SASE coverage record

- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: FortiClient EMS Administrator — FortiClient EMS design and deployment; FortiClient EMS Administrator — FortiClient provisioning and deployment; FortiClient EMS Administrator — Implement endpoint security; FortiClient EMS Administrator — Zero trust and Security Fabric integration; FortiClient EMS Administrator — Troubleshooting; FortiEDR Administrator — FortiEDR system; FortiEDR Administrator — FortiEDR security settings and policies; FortiEDR Administrator — Events, forensics, and threat hunting; FortiEDR Administrator — FortiEDR integration; FortiEDR Administrator — FortiEDR troubleshooting; FortiDLP Administrator — FortiDLP fundamentals and deployment (25–35%); FortiDLP Administrator — Data identification and enforcement (20–30%); FortiDLP Administrator — Detection and investigation (15–25%); FortiDLP Administrator — Troubleshooting (15–25%)
- Coverage evidence: guide sections 1–4, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 12 unique external guide URLs; 12 reachable, 0 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules
...
- Reviewed: September 2, 2026
- Outcome: **sources + objectives checked; human review pending**
- Official scope: Asset management; Network access control; Network security; Monitoring and risk assessment
- Coverage evidence: guide sections 1–5, scenarios, authorized labs, original checks, and explicit architecture, governance, operational, and security boundaries
- Link evidence: 11 unique external guide URLs; 10 reachable, 1 automation-blocked, 0 missing/broken in dated source-health evidence
- Volatile boundaries: live certification requirements, product versions, course availability, delivery, and renewal rules
