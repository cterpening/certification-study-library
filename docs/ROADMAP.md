...
| Cisco | 4 | Inventory checked September 2, 2026. 100-150 CCST Networking is source validated; continue with 100-160 CCST Cybersecurity, 200-301 CCNA, and 200-901 CCNA Automation. Treat CCNA v1.1 as current through February 2, 2027 and v2.0 as the scheduled February 3 replacement. |
