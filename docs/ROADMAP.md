...
| Microsoft | 45 | 50 | 5 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **54** | **95** | **41** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 5 guides in the ordered
...
The remaining selected Microsoft queue is therefore **5 exams**, not an open-
