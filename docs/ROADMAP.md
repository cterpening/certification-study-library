...
| Snowflake | 4 | Three of four complete: retired [SOL-C01 Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md), active [COF-C03 Core](../guides/COF-C03-snowpro-core.md), and active [DEA-C02 Advanced Data Engineer](../guides/DEA-C02-snowpro-advanced-data-engineer.md) are source validated. GES-C02 Specialty: Gen AI remains. Do not carry retired COF-C02 or GES-C01 forward as current. |
