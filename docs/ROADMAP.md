...
| Snowflake | 4 | Two of four complete: retired [SOL-C01 Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md) and active [COF-C03 Core](../guides/COF-C03-snowpro-core.md) are source validated. Next publish active DEA-C02 Advanced Data Engineer and GES-C02 Specialty: Gen AI. Do not carry retired COF-C02 or GES-C01 forward as current. |
