...
| Microsoft | 48 | 50 | 2 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **57** | **95** | **38** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 2 guides in the ordered
...
The remaining selected Microsoft queue is therefore **2 exams**, not an open-
