...
| Databricks | 5 | 7 | 2 | Data Analyst, both Data Engineer and both Machine Learning levels are published; two remain. |
...
| **Total** | **64** | **95** | **31** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
