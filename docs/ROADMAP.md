...
| Microsoft | 40 | 50 | 10 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **49** | **95** | **46** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 10 guides in the ordered
...
The remaining selected Microsoft queue is therefore **10 exams**, not an open-
