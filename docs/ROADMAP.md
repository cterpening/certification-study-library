...
| Microsoft | 47 | 50 | 3 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **56** | **95** | **39** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 3 guides in the ordered
...
The remaining selected Microsoft queue is therefore **3 exams**, not an open-
