...
| Snowflake | 4 | One of four complete: [SOL-C01 Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md) is preserved as a retired reference and directs new learners to the free, non-expiring Platform Skills Badge replacement. Next publish active COF-C03 Core, DEA-C02 Advanced Data Engineer, and GES-C02 Specialty: Gen AI. Do not carry retired COF-C02 or GES-C01 forward as current. |
