...
| Microsoft | 37 | 50 | 13 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **46** | **95** | **49** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 13 guides in the ordered
...
The remaining selected Microsoft queue is therefore **13 exams**, not an open-
