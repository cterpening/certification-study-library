...
| Microsoft | 41 | 50 | 9 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **50** | **95** | **45** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 9 guides in the ordered
...
The remaining selected Microsoft queue is therefore **9 exams**, not an open-
