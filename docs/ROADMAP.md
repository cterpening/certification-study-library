...
| Salesforce | 4 | Inventory complete September 2, 2026: [Salesforce Certified Platform Administrator](../guides/SALESFORCE-PLATFORM-ADMINISTRATOR-salesforce-certified-platform-administrator.md) is source validated; Platform App Builder, Platform Developer, and Agentforce Specialist follow. Preserve legacy Administrator and Platform Developer I labels only as search aliases; track seasonal exam versions and annual maintenance separately. |
