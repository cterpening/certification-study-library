...
| Databricks | 2 | 7 | 5 | Data Engineer and Data Analyst Associate are published; five current catalog certifications remain. |
...
| **Total** | **61** | **95** | **34** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
