...
| Microsoft | 39 | 50 | 11 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **48** | **95** | **47** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 11 guides in the ordered
...
The remaining selected Microsoft queue is therefore **11 exams**, not an open-
