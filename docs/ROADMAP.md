...
| Microsoft | 46 | 50 | 4 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **55** | **95** | **40** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 4 guides in the ordered
...
The remaining selected Microsoft queue is therefore **4 exams**, not an open-
