...
| NVIDIA | 3 | Two of three complete: [NCA-GENL Generative AI LLMs](../guides/NCA-GENL-nvidia-generative-ai-llms-associate.md) and [NCA-AIIO AI Infrastructure and Operations](../guides/NCA-AIIO-nvidia-ai-infrastructure-operations-associate.md) are source validated. Next publish hands-on NCP-AIO, which requires Linux CLI, Slurm, Kubernetes and Base Command Manager practice. |
