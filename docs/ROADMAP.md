...
| Microsoft | 38 | 50 | 12 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **47** | **95** | **48** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 12 guides in the ordered
...
The remaining selected Microsoft queue is therefore **12 exams**, not an open-
