...
| Salesforce | 4 | Two of four source validated: [Platform Administrator](../guides/SALESFORCE-PLATFORM-ADMINISTRATOR-salesforce-certified-platform-administrator.md) and [Platform App Builder](../guides/SALESFORCE-PLATFORM-APP-BUILDER-salesforce-certified-platform-app-builder.md). Platform Developer and Agentforce Specialist follow. The App Builder guide uses the corrected August 21, 2026 Summer ’26 blueprint rather than cached older weights. |
