...
| Microsoft | 43 | 50 | 7 | Selected current Microsoft catalog, excluding Microsoft Office Specialist and Microsoft Certified Educator; includes announced retirements while still earnable. |
...
| **Total** | **52** | **95** | **43** | Conditional/watch entries do not become publishable until their public source contract is sufficient. |
...
1. **Finish Microsoft:** complete the remaining 7 guides in the ordered
...
The remaining selected Microsoft queue is therefore **7 exams**, not an open-
