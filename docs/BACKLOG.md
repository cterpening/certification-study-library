...
| NVIDIA | 3 | One of three complete: [NCA-GENL Generative AI LLMs](../guides/NCA-GENL-nvidia-generative-ai-llms-associate.md) is source validated across its five weighted domains. Next publish NCA-AIIO, then the hands-on NCP-AIO; NCP-AIO requires Linux CLI, Slurm, Kubernetes and Base Command Manager practice. |
