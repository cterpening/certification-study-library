...
|---|---:|---|
| Google Cloud | 8 | Cloud Digital Leader, Generative AI Leader, Associate Cloud Engineer, Professional Cloud Architect, and [Professional Data Engineer](../guides/GOOGLE-PROFESSIONAL-DATA-ENGINEER-professional-data-engineer.md) are source validated; Professional Cloud Security Engineer and Machine Learning Engineer remain. Professional Agentic Architect is a published beta target with registration opening September 3, 2026. |
