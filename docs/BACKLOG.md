...
| Snowflake | 4 | Three of four complete: retired [SOL-C01 SnowPro Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md), active [COF-C03 SnowPro Core](../guides/COF-C03-snowpro-core.md), and active [DEA-C02 Advanced Data Engineer](../guides/DEA-C02-snowpro-advanced-data-engineer.md) are source validated. GES-C02 Specialty: Gen AI remains; GES-C01 retired July 20 and must not be used as current. |
