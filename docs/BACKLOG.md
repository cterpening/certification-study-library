...
| Cisco | 4 | Inventory checked September 2, 2026. [100-150 CCST Networking](../guides/100-150-cisco-certified-support-technician-networking.md), [100-160 CCST Cybersecurity](../guides/100-160-cisco-certified-support-technician-cybersecurity.md), and [200-301 CCNA](../guides/200-301-cisco-certified-network-associate.md) are source validated; 200-901 CCNA Automation remains. CCNA v1.1 stays live through February 2, 2027; the guide separately maps its published v2.0 replacement beginning February 3. |
