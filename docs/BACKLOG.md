...
| Salesforce | 4 | Two of four source validated: [Platform Administrator](../guides/SALESFORCE-PLATFORM-ADMINISTRATOR-salesforce-certified-platform-administrator.md) and [Platform App Builder](../guides/SALESFORCE-PLATFORM-APP-BUILDER-salesforce-certified-platform-app-builder.md). Platform Developer and Agentforce Specialist remain; preserve legacy names only as useful search aliases. |
