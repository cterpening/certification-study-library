...
| Snowflake | 4 | One of four complete: [SOL-C01 SnowPro Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md) is a source-validated retired reference pointing to the May 5 free, non-expiring Snowflake University Platform Skills Badge. Active COF-C03 Core, DEA-C02 Advanced Data Engineer, and GES-C02 Specialty: Gen AI remain. GES-C01 retired July 20 and must not be used as current. |
