...
| Snowflake | 4 | Two of four complete: retired [SOL-C01 SnowPro Associate: Platform](../guides/SOL-C01-snowpro-associate-platform.md) and active [COF-C03 SnowPro Core](../guides/COF-C03-snowpro-core.md) are source validated. DEA-C02 Advanced Data Engineer and GES-C02 Specialty: Gen AI remain. GES-C01 retired July 20 and must not be used as current. |
