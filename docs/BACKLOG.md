...
|---|---:|---|
| Google Cloud | 8 | Cloud Digital Leader, Generative AI Leader, Associate Cloud Engineer, and [Professional Cloud Architect](../guides/GOOGLE-PROFESSIONAL-CLOUD-ARCHITECT-professional-cloud-architect.md) are source validated; Professional Data Engineer, Cloud Security Engineer, and Machine Learning Engineer remain. Professional Agentic Architect is a published beta target with registration opening September 3, 2026. |
