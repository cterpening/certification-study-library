...
| Salesforce | 4 | Three of four source validated: [Platform Administrator](../guides/SALESFORCE-PLATFORM-ADMINISTRATOR-salesforce-certified-platform-administrator.md), [Platform App Builder](../guides/SALESFORCE-PLATFORM-APP-BUILDER-salesforce-certified-platform-app-builder.md), and [Platform Developer](../guides/SALESFORCE-PLATFORM-DEVELOPER-salesforce-certified-platform-developer.md). Agentforce Specialist remains; preserve legacy names only as useful search aliases. |
