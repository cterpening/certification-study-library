...
| Salesforce | 4 | Inventory complete September 2, 2026: Salesforce Certified Platform Administrator, Platform App Builder, Platform Developer, and Agentforce Specialist. Legacy Administrator and Platform Developer I names remain useful search aliases, not the current display titles. |
