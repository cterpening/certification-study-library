...
This catalog complements the study guides with several learning formats. It is a curated starting point, not a complete list of worthwhile instructors, courses, books, labs, or providers. It does not rank one learning style as universally best, and inclusion is not an endorsement of every course sold by a provider.
...
Each guide's final `Places to learn` table estimates the time needed to consume that resource at normal speed. A provider-published runtime, agenda, or course duration is used when available. Otherwise the table says `about`, gives a range, and makes the basis of the library estimate clear. Reading estimates assume active reading, not merely page count.
...
2. Complete the matching official learning paths when available.
3. Keep first-party product documentation open for current behavior.
4. Practice in a disposable repository, tenant, subscription, or sandbox appropriate to the technology.
5. Add one course, book, or video series that fits how you learn; add more only when they close a specific gap.
6. Return to the blueprint and explain or demonstrate every objective without notes.

## How resources are selected

A listed resource should have a clear author or publisher, teach concepts rather than claim access to live exam items, and offer useful coverage beyond a question bank. Resources are excluded when they advertise dumps, recalled or “actual” questions, guaranteed passes, or unexplained answer banks.

Third-party resources are evaluated individually. A trustworthy marketplace can still contain an unsuitable or stale course. Ratings and popularity are discovery signals, not evidence that technical claims are correct.

## Core first-party and free resources
...
| [Microsoft Learn course videos](https://learn.microsoft.com/en-us/training/course-videos-on-shows) | Free | Microsoft Certified Trainer video sessions that reinforce the written paths |
| [Microsoft Reactor](https://www.youtube.com/@MicrosoftReactor) | Free | Official workshops and live-session recordings for GitHub, Azure, Microsoft Foundry, agents, and adjacent developer topics; select sessions by a known objective gap |
| [GitHub YouTube](https://www.youtube.com/@GitHub) | Free | Product demonstrations, feature explanations, and event sessions |
| [Microsoft Foundry documentation](https://learn.microsoft.com/en-us/azure/foundry/) | Free | Current Foundry, model, agent, evaluation, and operations behavior |
...
- Official: [Microsoft Learn Part 1](https://learn.microsoft.com/en-us/training/paths/github-foundations/) and [Part 2](https://learn.microsoft.com/en-us/training/paths/github-foundations-2/)
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft GH-900 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/github-foundations/practice/assessment?assessment-type=practice&assessmentId=954809103&practice-assessment-type=certification); Microsoft account required
- Official video: [Microsoft Learn GH-900 playlist](https://www.youtube.com/playlist?list=PLahhVEj9XNTf5iQVK_80RdvTju7ov6RYy)
- Official supporting session (1 hour): [Microsoft Reactor — From Git to GitHub Foundations](https://www.youtube.com/watch?v=W86EkkBdquo); useful current orientation, not a replacement for the objective-mapped Learn paths
- Hands-on: [Introduction to GitHub](https://github.com/skills/introduction-to-github) and the wider [GitHub Skills catalog](https://github.com/skills)
- Structured subscription path: [Pluralsight GitHub Foundations](https://www.pluralsight.com/paths/github-foundations)
...
- Subscription assessment (about 2–4 hours for an attempt and review): [O'Reilly certification prep](https://www.oreilly.com/products/certification-prep.html), whose current public catalog lists a GitHub Foundation interactive practice test
...
- Official: [Microsoft Learn Part 1](https://learn.microsoft.com/en-us/training/paths/github-actions/) and [Part 2](https://learn.microsoft.com/en-us/training/paths/github-actions-2/)
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft GH-200 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/github-actions/practice/assessment?assessment-type=practice&assessmentId=1001&practice-assessment-type=certification); Microsoft account required
- Official video: [Microsoft Learn GH-200 playlist](https://www.youtube.com/playlist?list=PLahhVEj9XNTd5N_seZDoRXVIn6N1qAp-_)
...
- Subscription assessment (about 2–4 hours for an attempt and review): [O'Reilly certification prep](https://www.oreilly.com/products/certification-prep.html), whose current public catalog lists a GitHub Actions interactive practice test
...
- Official: [Microsoft Learn Part 1](https://learn.microsoft.com/en-us/training/paths/github-administration-products/) and [Part 2](https://learn.microsoft.com/en-us/training/paths/github-admin-2/github-admin-2/)
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft GH-100 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/github-administration/practice/assessment?assessment-type=practice&assessmentId=1841205577&practice-assessment-type=certification); Microsoft account required
...
- Official: [Microsoft Learn Part 1](https://learn.microsoft.com/en-us/training/paths/github-advanced-security/) and [Part 2](https://learn.microsoft.com/en-us/training/paths/github-advanced-security-2)
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft GH-500 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/github-advanced-security/practice/assessment?assessment-type=practice&assessmentId=590484996&practice-assessment-type=certification); Microsoft account required
...
- Structured subscription path and practice exam: [Pluralsight GH-500](https://www.pluralsight.com/paths/gh-500-github-advanced-security), 13 hours of courses plus about 2–4 hours for the practice attempt and review; taught by [Timothy Warner](https://www.pluralsight.com/authors/tim-warner) and updated in 2026
...
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft AZ-900 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/azure-fundamentals/practice/assessment?assessment-type=practice&assessmentId=23&practice-assessment-type=certification); Microsoft account required
- Partner-restricted official training (10 hours): [Microsoft Partner Skilling Hub LevelUp AZ-900](https://www.skilling-hub.com/en-US/listing/o::levelup::2058307); **Partner login required** with an eligible partner work account
- Public review (about 4 hours): [John Savill's AZ-900 Study Cram](https://www.youtube.com/watch?v=tQp1YkB2Tgs); published for the 2022 scope, so use it as explanation rather than a July 2026 checklist
- Structured subscription path (21 hours plus labs) and practice exam (about 2–4 additional hours): [Pluralsight AZ-900](https://www.pluralsight.com/paths/microsoft-certified-azure-fundamentals-az-900), updated through 2026
...
- Subscription assessment (about 2–4 hours for an attempt and review): [O'Reilly certification prep](https://www.oreilly.com/products/certification-prep.html), whose current public catalog lists an AZ-900 interactive practice test
...
- Official (1 day): [Microsoft Learn PL-900 course](https://learn.microsoft.com/en-us/training/courses/pl-900t00)
- Free official assessment (about 1–2 hours for an attempt and review): [Microsoft PL-900 Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/power-platform-fundamentals/practice/assessment?assessment-type=practice&assessmentId=34&practice-assessment-type=certification); Microsoft account required
- Partner-restricted official training (10 hours): [Microsoft Partner Skilling Hub LevelUp PL-900](https://www.skilling-hub.com/en-US/listing/o::levelup::2058317); **Partner login required** with an eligible partner work account
- Structured subscription path (9 hours) and practice exam (about 2–4 additional hours): [Pluralsight PL-900](https://www.pluralsight.com/paths/microsoft-power-platform-fundamentals-pl-900); several components predate the July 2026 Copilot Studio, Agent 365, Plan designer, and code-app scope
- Long-form video (16 hours 40 minutes): [O'Reilly Complete PL-900 Masterclass](https://www.oreilly.com/videos/the-complete-masterclass/9781805125044/), published November 2023; durable core implementation, not a current blueprint map
...
| Creator or channel | Useful for | Boundary |
|---|---|---|
| [Microsoft Learn](https://www.youtube.com/@MicrosoftLearn) | Current official GH-900, GH-200, GH-300, and GH-500 course playlists | Use the written blueprint as the final scope checklist. No GH-100 course playlist was listed in Microsoft's course-video catalog at this review. |
| [GitHub](https://www.youtube.com/@GitHub) | Current product demonstrations and conference sessions | Content is organized around products and events, not necessarily exam objectives. |
| [Microsoft Reactor](https://www.youtube.com/@MicrosoftReactor) | Official workshops and recordings across GitHub, Azure, Foundry, agents, and Agentic DevOps. Verified examples include [From Git to GitHub Foundations](https://www.youtube.com/watch?v=W86EkkBdquo), [Secure by Design with GitHub Copilot](https://www.youtube.com/watch?v=DyGumvvyYy8), the [Foundry Toolkit for VS Code series](https://www.youtube.com/playlist?list=PLfFkrJrvj_-w), and the [Agentic DevOps webinar series](https://www.youtube.com/playlist?list=PLmsFUfdnGr3zIttDspAtrZ-_-KQxsq0-1). | Strong first-party discovery and related depth, but the catalog is topic- and event-led rather than mapped to certification objectives. Check each recording date, language, and scope, then map it to the current blueprint. |
| [John Savill's Technical Training](https://www.youtube.com/@NTFAQGuy) | The [DevOps Master Class](https://www.youtube.com/playlist?list=PLlVtbbG169nFr8RzQ4GIxUEznpNR53ERq), its public [companion repository](https://github.com/johnthebrit/DevOpsMC), especially [Part 2: Master Git](https://www.youtube.com/watch?v=hQJktcBzJUs), [Part 3: Azure DevOps and GitHub](https://www.youtube.com/watch?v=Z9evyML2I6M), and [Part 4: CI/CD](https://www.youtube.com/watch?v=nLRHV2sRTe8) | Excellent supporting explanations and artifacts for GH-900 and GH-200 topics, including repositories, collaboration, branch protection, GitHub Actions, runners, environments, and secrets. The 2021 series is not a current end-to-end GitHub certification course, and the repository has no detected license, so link rather than republish its files. |
| [freeCodeCamp.org](https://www.youtube.com/@freecodecamp) / Andrew Brown | A long-form [GitHub Foundations certification course](https://www.youtube.com/watch?v=Jdc0i7RcBv8) with demonstrations | Published for an older blueprint; use it for fundamentals and fill 2026 objective gaps from Microsoft Learn. |
| [Timothy Warner](https://www.youtube.com/@TechTrainerTim) | GitHub, DevOps, Copilot, and security explanations; the public [GH-300 companion repository](https://github.com/timothywarner-org/copilot-cert-prep); his earlier [O'Reilly crash course](https://learning.oreilly.com/live-events/github-copilot-certification-crash-course/0642572013405/0642572354893/), upcoming [September GH-300 course](https://www.oreilly.com/live-events/pass-your-github-copilot-certification-exam/0642572414696/0642572414689/), and [Pluralsight courses](https://www.pluralsight.com/authors/tim-warner) | Check the date and current blueprint. Each public repository, O'Reilly course occurrence, and Pluralsight course has its own scope and access terms. |
...
| [John Savill's Technical Training](https://www.youtube.com/@NTFAQGuy) — SC-100 | [SC-100 Cybersecurity Architect Expert Study Cram](https://www.youtube.com/watch?v=2Qu5gQjNQh4) (1 hour 38 minutes) | Strong Zero Trust and Microsoft security architecture foundation with visual explanation. It was published in May 2022 and is not current coverage for the July 28, 2026 blueprint; specifically close AI security, Entra Agent ID, Exposure Management, Microsoft 365 Copilot, and current SSE gaps with Microsoft Learn. |
...
## Contributing a learning resource

When proposing a resource, include the exact course, book, playlist, or repository—not just the provider—and record:

- author or instructor;
- format and access model;
- publication and last-update dates shown by the provider;
- exam objectives it supports;
- strengths, prerequisites, and known gaps;
- any licensing or exam-integrity concern.

Do not copy paid material, transcripts, slides, or proprietary labs. Summarize independently, attribute ideas, and cite current first-party documentation for technical behavior.
